...
public class RabbitMQConfiguration implements RabbitListenerConfigurer {
    ...
    @Bean
    public TopicExchange priceCalculationExchange(
            @Value("${priceCalculation.exchange}")final String exchangeName
    ){
    ...
    Binding binding(final Queue queue, final TopicExchange exchange,
                    @Value("${price.CTypeCalculated.key}") final String routingKey) {
